...
// the endpoint. Nothing depends on it succeeding: routemateSyncVehicles() runs
// routemateHydrateVehicleDetails() on the CATCH path, and vehicle discovery is
// already covered by listLiveLocations() (polled every 60 s) plus the
// telemetry-derived id fallback.
...
// not be null" rather than 404. Callers must treat any 4xx as "not a Routemate
// vehicle" and stop asking; request() already fails fast on 4xx without retry.
