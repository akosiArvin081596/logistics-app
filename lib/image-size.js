...
const LIMITS = Object.freeze({
	...
	// forms re-encode every photo to a JPEG at most 1200 px on its long edge, a
	// few hundred KB, so only a client other than the app comes near 16 MP or
	// 2 MiB; checkImage() enforces both (413 IMAGE_TOO_LARGE).
