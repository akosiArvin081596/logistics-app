...
// MM/DD/YYYY in HOUSTON time, not server-local.
//
...
// 8:30 PM Houston on Jul 31 as 08/01/2026 — the wrong month on a document that
// drives the broker's aging and payment terms.
//
// Intl/formatToParts rather than an offset: America/Chicago switches CST<->CDT,
// so a hardcoded -5 or -6 is wrong for half the year.
function mdy(d) {
