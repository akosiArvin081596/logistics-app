...
// The "Invoice To" block + the address the Gmail draft is sent to. Bison
// keeps its own AP inbox byte-for-byte; everything else bills quickpay.
function resolveInvoiceTo(ctx = {}) {
	...
	return {
		...
		email: bison ? BISON_INVOICE_EMAIL : DEFAULT_INVOICE_EMAIL,
	};
}
