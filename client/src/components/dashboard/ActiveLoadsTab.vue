<template>
  <div>
          ...
          <tr v-for="job in paginatedItems" :key="job._rowIndex" class="border-b border-white/5 hover:bg-white/[0.02] cursor-pointer" @click="openDetail(job)">
            ...
            <td class="px-3 py-2.5" @click.stop>
              <div class="flex items-center gap-1.5 flex-wrap">
                <select v-model="statusSelections[job._rowIndex]" class="px-2 py-1 text-xs bg-white/5 border border-white/10 rounded text-white outline-none w-[110px]">
                ...
                <select v-model="reassignSelections[job._rowIndex]" class="px-2 py-1 text-xs bg-white/5 border border-white/10 rounded text-white outline-none w-[120px]">
    ...
    <Teleport to="body">
      <div v-if="selectedJob" class="fixed inset-0 bg-black/40 backdrop-blur-sm z-[200] flex items-center justify-center" @click.self="closeDetail">
        <div class="bg-[var(--bg)] rounded-2xl w-[92%] max-w-[680px] max-h-[85vh] flex flex-col shadow-2xl">
          <div class="flex items-center justify-between px-5 py-4 border-b border-white/10">
            ...
            <button class="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-white/10 text-gray-400 hover:text-white text-xl" @click="closeDetail">&times;</button>
          </div>
