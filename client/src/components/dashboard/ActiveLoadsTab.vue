<template>
  <div>
    <div class="toolbar">
      <SelectButton v-model="viewMode" :options="[{label:'List',value:'list'},{label:'Map',value:'map'}]" option-label="label" option-value="value" :allow-empty="false" @change="onViewChange" />
    ...
    <LoadsMapView v-show="viewMode === 'map'" :loads="jobs" :headers="headers" category="active" :driver-locations="driverLocations" :visible="viewMode === 'map'" />
