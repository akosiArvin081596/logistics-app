...
const cards = computed(() => [
  ...
  { key: 'completed', icon: '✓', label: 'Completed', value: props.kpis.completedThisMonth, sub: `${props.kpis.completedThisWeek} this week`, theme: 'kpi-emerald', iconTheme: 'kpi-icon-emerald' },
